        ...
        function a(t) {
            if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var g = r.paddingLeft + r.paddingRight,
                    ...
                    w = a && d,
                    E = e(i.width);
                E !== !1 && (r.width = E + (w ? 0 : g + C));
                var P = e(i.height);
                return P !== !1 && (r.height = P + (w ? 0 : m + S)), r.innerWidth = r.width - (g + C), r.innerHeight = r.height - (m + S), r.outerWidth = r.width + b, r.outerHeight = r.height + x, r
            }
        }
...
function(t, e) {
    ...
    h.defaults = {
        ...
        if (!this.isActive) {
            ...
            l(t, this.slider), this.viewport.appendChild(this.slider), this.element.appendChild(this.viewport), this.getSize(), this.reloadCells(), this.setContainerSize(), this.options.accessibility && (this.element.tabIndex = 0, n.bind(this.element, "keydown", this)), this.emit("activate"), this.positionSliderAtSelected(), this.select(this.selectedIndex)
        }
        ...
        this.cells = this._makeCells(this.slider.children), this.positionCells(), this._getWrapShiftCells(), this.setContainerSize()
    ...
    h.prototype.setCellAlign = function() {
    ...
    }, h.prototype.setContainerSize = function() {
        ...
        if (this.options.contain && !this.options.wrapAround && this.cells.length)
            for (var t = this.options.rightToLeft ? "marginRight" : "marginLeft", e = this.options.rightToLeft ? "marginLeft" : "marginRight", i = this.cells[0].size[t], n = this.getLastCell(), o = this.slideableWidth - n.size[e], r = o - this.size.innerWidth * (1 - this.cellAlign), s = 0, a = this.cells.length; a > s; s++) {
                var l = this.cells[s];
                l.setDefaultTarget(), l.target = Math.max(l.target, this.cursorPosition + i), l.target = Math.min(l.target, r)
            }
        ...
        if (this.emitEvent(t, n), c && this.$element)
            if (e) {
                var o = c.Event(e);
                o.type = t + ".flickity", this.$element.trigger(o, i)
            } else this.$element.trigger(t, i)
    }, h.prototype.select = function(t, e) {
        if (this.isActive) {
            var i = this.cells.length;
            this.options.wrapAround && i > 1 && (0 > t ? this.x -= this.slideableWidth : t >= i && (this.x += this.slideableWidth)), (this.options.wrapAround || e) && (t = r.modulo(t, i)), this.cells[t] && (this.selectedIndex = t, this.setSelectedCell(), this.startAnimation(), this.dispatchEvent("select"))
        }
        ...
        this.isActive && (this.getSize(), this.options.wrapAround && (this.x = r.modulo(this.x, this.slideableWidth)), this.positionCells(), this._getWrapShiftCells(), this.setContainerSize(), this.positionSliderAtSelected())
    };
    ...
    h.prototype.watchCSS = function() {
        ...
        this.deactivate(), this.isResizeBound && n.unbind(t, "resize", this), this.emit("destroy"), delete this.element.flickityGUID, delete f[this.guid]
...
function(t, e) {
    ...
    return r.prototype = new n, r.prototype._create = function() {
        ...
        this.onselect = function() {
            o.update()
        }, this.parent.on("select", this.onselect), this.on("tap", this.onTap), this.on("pointerDown", function(t, e) {
...
function(t, e) {
    ...
    return r.prototype = new n, r.prototype._create = function() {
        ...
        this.onselect = function() {
            t.updateSelected()
        }, this.parent.on("select", this.onselect), this.on("tap", this.onTap), this.on("pointerDown", function(e, i) {
...
function(t, e) {
    ...
    return e.prototype.insert = function(t, e) {
        ...
        for (e = 0, n = r.length; n > e; e++) o = r[e], o.remove(), i.removeFrom(o, this.cells);
        ...
        t = t || 0, this._positionCells(t), this._getWrapShiftCells(), this.setContainerSize(), this.options.freeScroll ? this.positionSlider() : (this.positionSliderAtSelected(), this.select(this.selectedIndex))
    }, e
}),
function(t, e) {
...
function(t, e) {
    ...
    return i.createMethods.push("_createAsNavFor"), i.prototype._createAsNavFor = function() {
        ...
        if (e && e != this) {
            ...
            }, e.on("select", this.onNavCompanionSelect), this.on("staticClick", this.onNavStaticClick), this.navCompanionSelect()
        }
    ...
    }, i.prototype.onNavStaticClick = function(t, e, i) {
...
function(t, e) {
    "function" == typeof define && define.amd ? define(["flickity/js/index", "imagesloaded/imagesloaded", "fizzy-ui-utils/utils"], function(i, n, o) {
        return e(t, i, n, o)
    }) : "object" == typeof exports ? module.exports = e(t, require("flickity"), require("imagesloaded"), require("fizzy-ui-utils")) : t.Flickity = e(t, t.Flickity, t.imagesLoaded, t.fizzyUIUtils)
}(window, function(t, e, i, n) {
    return e.createMethods.push("_createImagesLoaded"), e.prototype._createImagesLoaded = function() {
        ...
        function t(t, i) {
            var o = e.getCell(i.img),
                r = o && o.element || n.getParent(i.img, ".flickity-slider > *");
            e.cellSizeChange(r)
        }
